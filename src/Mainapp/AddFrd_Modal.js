    ...
    <div className={showHideClassName}>
      <div className="modal-main">
        ...
        <form id="secretcode_form" onSubmit={(e)=>handleAddFrd(e)}>
                ...
                <br />
                <button className="modal_buttons add" type="submit">Add friend</button>
                <button className="modal_buttons close" type="button" onClick={handleClose}>
                  Close
                </button>
